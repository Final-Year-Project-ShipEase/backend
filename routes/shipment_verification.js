...
router.post('/shipmentVerification', shipmentVerificationController.createShipment);
router.put('/shipmentVerification/:id', shipmentVerificationController.updateShipment);
router.delete('/shipmentVerification/:id', shipmentVerificationController.deleteShipmentById);
